...
class FSDPParam:
    ...
    # all-gather output that must not be freed/reallocated by FSDP
    ...
    def init_param_contiguous_all_gather_outputs(
        ...
        if (
            ...
            # The unsharded parameter from a previous all-gather no longer aliases
            # the backend buffer; drop it so it is rebuilt over the new storage.
    ...
    def free_unsharded_param(self) -> None:
        ...
        # only its storage is left intact across reshards.
